/* 1. Given a string of characters as input, write a function
...
function longestOccurance(str){
	...
	return maxOccurance;
	// Alternatively, asides the reduced method the lines of codes below can be used to achieve same result
	// let maxOccurance = ""
	// let maxCount = 0
